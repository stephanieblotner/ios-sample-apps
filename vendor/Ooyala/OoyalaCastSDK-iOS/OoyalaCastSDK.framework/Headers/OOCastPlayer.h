...
- (void)enterCastModeWithOptions:(OOCastModeOptions *)options embedToken:(NSString *)embedToken domain:(OOPlayerDomain *)domain additionalInitParams:(NSDictionary *)params;
