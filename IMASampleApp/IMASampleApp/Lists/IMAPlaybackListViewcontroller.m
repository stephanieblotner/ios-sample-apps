...
- (void)addAllPlayerSelectionOptions {
  [self insertNewObject: [[PlayerSelectionOption alloc] initWithTitle:@"PBA-2114" embedCode:@"d4eGZxdTqP2cr1YkPlHch_ENVcryRIpX" viewController: [IMAPlayerViewController class]]];
